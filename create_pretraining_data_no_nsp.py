...
def create_instances_from_document(
  ...
  #       if (len(tokens_a) == 0):
  #         print('len of document')
  #         print(len(document))
  #         print('document index')
  #         print(document_index)
  #         print('chunk')
  #         print(current_chunk)
  #         print('zeroth elem of curr chunk')
  ...
  #       #! k is a new argument, meant to represent the size of kmers in the training data
  #       # it is used to dteermine how many contiguous tokens must be maskes so as not to 
  #       # trivialize the masked LM prediction because of neighbouring kmer overlap
  #       (tokens, masked_lm_positions,
  #        masked_lm_labels) = create_masked_lm_predictions(
  #            tokens, masked_lm_prob, max_predictions_per_seq, vocab_words, rng, k, gapfactor)
  #       instance = TrainingInstance(
